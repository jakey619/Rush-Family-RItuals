...
export const DEFAULT_PROFILES = [
  {
    ...
    exerciseItems: [
      ...
      item("Butterfly"),
      item("Right Leg Extended"),
      item("Left Leg Extended"),
      item("Both Legs Extended"),
      item("Straddle Right"),
      item("Straddle Left"),
      item("Straddle Middle"),
      item("Laying Quad Stretch Right"),
      item("Laying Quad Stretch Left"),
      item("Lady's Stretch Right"),
      item("Lady's Stretch Left"),
      item("Man's Stretch Right"),
      item("Man's Stretch Left"),
      item("Lunge Stretch to Rock Back Hamstring Stretch (Right)"),
      item("Lunge Stretch to Rock Back Hamstring Stretch (Left)"),
      item("Pigeon Lunge (Right)"),
      item("Pigeon Lunge (Left)"),
      item("Downwards Dog"),
      item("Sumo"),
      item("Foward Bend"),
      item("Calf Stretch A (Right)"),
      item("Calf Stretch A (Left)"),
      item("Calf Stretch B (Right)"),
      item("Calf Stretch B (Left)"),
      item("An hour of Normatec"),
    ],
  },
  {
    id: "anaya",
